package com.api_pagamento.elastic_search;
...
public class ApiPagamentoElasticSearch {

    public static void main(String[] args) {
        SpringApplication.run(ApiPagamentoElasticSearch.class, args);
    }
    ...
    public class SwaggerConfig {
        ...
        public Docket api() {
            return new Docket(DocumentationType.SWAGGER_2)
                    .select()
                    .apis(RequestHandlerSelectors.basePackage("com.api_pagamento.elastic_search.controller"))

...
import com.api_pagamento.elastic_search.service.TransacaoService;
...
public class TransacaoController {
    ...
    @ApiOperation(value = "Procura uma transação pelo valor de um campo")
    @ApiResponses(value = {
    ...
    @GetMapping(value = "/value/{value}", produces = "application/json")
    public ResponseEntity<List<TransacaoDTO>>findBy(@PathVariable String value) throws TransacaoInexistenteException {

       return ResponseEntity.ok().body(transacaoService.findBy(value));
    ...
    public ResponseEntity<TransacaoDTO> procurarPeloId(@PathVariable String id) throws TransacaoInexistenteException {

        return ResponseEntity.ok().body(transacaoService.findById(id));
    ...
    public ResponseEntity<List<TransacaoDTO>> findAll() throws TransacaoInexistenteException {
    ...
    public ResponseEntity<TransacaoDTO> estornar(@PathVariable String id) throws TransacaoInexistenteException {
